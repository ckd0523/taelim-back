...
public class PasswordHasher {
    ...
    public boolean verifyHashedPasswordV3(String hashedPasswordBase64, String password) {
    ...
    private byte[] hashPasswordWithSalt(char[] password, byte[] salt, int iterations, int keyLength) {
        try {
