...
public class clsPrinterCommand 
{
	...
	//---------------------------------------------------------------------------
	// Print Text (More Parameter) - Unicode
	//---------------------------------------------------------------------------
	int PrintText_Unicode(int PosX, int PosY, int FontHeight, String FontName, String Data, int TextWidth, FontWeight Dark, RotateMode Rotate)
	{
		byte[] byteData = null;
		try {
			byteData = Data.getBytes("UTF-16LE");
	    ...
	    return API.ecTextOutRW(PosX, PosY, FontHeight, FontName, byteData, TextWidth, Dark.Val(), Rotate.Val(),Data.length());
	}
	...
	//---------------------------------------------------------------------------
	// Print Text (Detail Parameter) - Unicode
	//---------------------------------------------------------------------------
	int PrintText_Unicode(int PosX, int PosY, int FontHeight, String FontName, String Data, int TextWidth, FontWeight Dark, RotateMode Rotate, Italic_State Italic, Underline_State Underline, Strikeout_State Strikeout, Inverse_State Inverse)
	{
		byte[] byteData = null;
		try {
			byteData = Data.getBytes("UTF-16LE");
		...
		return API.ecTextOutFineW(PosX, PosY, FontHeight, FontName, byteData, TextWidth, Dark.Val(), Rotate.Val(), Italic.Val(), Underline.Val(), Strikeout.Val(), Inverse.Val(),Data.length());				    
	}
