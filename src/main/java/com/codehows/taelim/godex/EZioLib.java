...
public class EZioLib
{
	...
	static {
		try {
			String libraryPath = "/gen/GodexTerminal/libezio.so.1.1.0";
	...
	public interface API extends Library
	{
		...
		String path = API.class.getResource("/GodexTerminal/libezio.so.1.1.0").getPath();
		...
		public int ecTextOutW(int PosX, int PosY, int FontHeight, String FontName, byte[] data,int textlength);
		public int ecTextOutR(int PosX, int PosY, int FontHeight, String FontName, String data, int width,int weight,int rotation);
		public int ecTextOutRW(int PosX, int PosY, int FontHeight, String FontName, byte[] data, int width,int weight,int rotation,int textlength);
		...
		public int ecTextOutFineW(int PosX, int PosY, int FontHeight, String FontName, byte[] data, int width,int weight,int rotation,int italic,int under,int strike,int inverse,int textlength);
